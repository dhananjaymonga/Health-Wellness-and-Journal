...
function TakeControl() {
  return (
    <div>  <div className="text-center p-6 max-w-2xl mx-auto">
    <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-purple-700 mb-4">Take Control of Your Health</h1>
